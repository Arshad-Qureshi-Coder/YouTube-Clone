...
async function extractVideoDetails(videoId){ 
    ...
    let endpoint = `https://youtube.googleapis.com/youtube/v3/commentThreads?part=snippet&videoId=${videoId}&key=${apiKey}`;
...
async function  fetchStats(videoId){
    ...
    let endpoint = `https://youtube.googleapis.com/youtube/v3/videos?part=snippet,statistics&id=${videoId}&key=${apiKey}`;
